...
(function($) {
    ...
    $("#module-open").on("click", function(e) {
        $('.module-icon').parent().siblings().removeClass(moduleActive); // Remove the class .active form any sibiling.
        $('.module-icon').parent('.module').toggleClass(moduleActive); //Add the class .active to parent .module for this element.
        e.stopPropagation();
    });
